...
#segment(dlab, 'girl-with-hat.png', 'background-building.png', show_orig=False)
#segment(dlab, 'girl.png', 'forest.png', show_orig=False)




segment(dlab, 'CS12.jpg', 'CS10.jpg', show_orig=False)